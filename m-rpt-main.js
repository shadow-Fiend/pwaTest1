...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_55__, __WEBPACK_EXTERNAL_MODULE_38__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_53__, __WEBPACK_EXTERNAL_MODULE_114__) {
...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-rpt-main',
		children: [{
			name: 'tabs',
			component: 'Tabs',
			tabs: [{ title: '业务' }, { title: '财务' }, { title: '税务' }, { title: '风险' }],
			page: '{{data.currentTab}}',
			tabBarPosition: 'top',
			swipeable: false,
...
var action = function action(option) {
    ...
    this.handleTabClick = function (tab, index) {
