...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_55__, __WEBPACK_EXTERNAL_MODULE_38__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_53__, __WEBPACK_EXTERNAL_MODULE_114__) {
...
var _webapi = __webpack_require__(66);
...
function getMeta() {
	return {
		...
		children: [{
			...
			tabBarInactiveTextColor: '#C8E8FD',
			tabBarActiveTextColor: '#fff',
			tabs: [{ title: '收入' }, { title: '支出' }, { title: '转账' }, { title: '收款' }, { title: '付款' }],
			initialPage: '{{data.initPage || 0}}',
			tabBarPosition: 'top',
			swipeable: false,
			children: [{
				name: 'income',
				component: 'AppLoader',
				appName: 'm-acc-charge-income'
			}, {
				name: 'payment',
				component: 'AppLoader',
				appName: 'm-acc-charge-payment'
			}, {
				name: 'transfer',
				component: 'AppLoader',
				appName: 'm-acc-charge-transfer'
			}, {
				name: 'receivable',
				component: 'AppLoader',
				appName: 'm-acc-charge-receivable'
			}, {
				name: 'payable',
				component: 'AppLoader',
				appName: 'm-acc-charge-payable'
			}, {
				name: 'cost',
				component: 'AppLoader',
				appName: 'm-acc-charge-cost'
			}]
		}]
	};
}
...
var _mkComponent = __webpack_require__(114);

var _mkMetaEngine = __webpack_require__(38);

var _immutable = __webpack_require__(55);

var _mkUtils = __webpack_require__(18);
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        var info = component.props.info || {};
        if (info.businessTypeCode) {
            _this.showNeedTab(info.businessTypeCode);
        }
    };

    this.showNeedTab = function (code) {
        switch (code.slice(0, 2)) {
            case '10':
                _this.metaAction.sf('data.initPage', 0);
                break;
            case '20':
                _this.metaAction.sf('data.initPage', 1);
                break;
            case '40':
                _this.metaAction.sf('data.initPage', 2);
                break;
            case '50':
                code.slice(0, 3) == '501' ? _this.metaAction.sf('data.initPage', 3) : _this.metaAction.sf('data.initPage', 4);
                break;
        }
    };
...
exports.default = {
    name: "m-acc-charge",
    version: "1.0.0",
    description: "m-acc-charge",
    meta: data.getMeta(),
    components: [],
    config: config,
    load: function load(cb) {
        cb(__webpack_require__(49), __webpack_require__(54), __webpack_require__(56));
    }
};
module.exports = exports['default'];
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(40)(Function.call, __webpack_require__(52).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
