...
function getMeta() {
	return {
		...
		children: [{
			...
			name: 'content',
			component: '::div',
			className: 'm-inv-checkResult-content',
			children: [{
				name: 'contentTop',
				component: '::div',
				className: 'm-inv-checkResult-contentTop',
				children: '查验成功发票一致'
			}, {
				name: 'contentCentral',
				component: '::div',
				children: [{
					name: 'type',
					component: '::div',
					className: 'm-inv-checkResult-type',
					children: '{{data.form.invoiceType}}'
				}, {
					name: 'invoice',
					component: '::div',
					className: 'm-inv-checkResult-invoice',
					children: [{
						name: 'invoiceCode',
						component: 'List.Item',
						children: '发票代码：',
						extra: '{{data.form.invoiceCode}}'
					}, {
						name: 'invoiceNo',
						component: 'List.Item',
						children: '发票号码：',
						className: 'm-inv-checkResult-marBot',
						extra: '{{data.form.invoiceNo}}'
					}, {
						name: '价税合计',
						component: 'List.Item',
						children: '价税合计：',
						extra: '{{data.form.totalAmount}}'
					}, {
						name: '发票金额：',
						component: 'List.Item',
						children: '发票金额：',
						extra: '{{data.form.invoiceAmount}}'
					}, {
						name: '发票税额：',
						component: 'List.Item',
						className: 'm-inv-checkResult-marBot',
						children: '发票税额：',
						extra: '{{data.form.taxAmount}}'
					}, {
						name: '机器编号',
						component: 'List.Item',
						className: 'm-inv-checkResult-dashed',
						children: '机器编号：',
						extra: '{{data.form.machineNo}}'
					}, {
						name: '销方名称',
						component: 'List.Item',
						children: '销方名称',
						extra: '{{data.form.salerName}}'
					}, {
						name: '销方税号',
						component: 'List.Item',
						children: '销方税号：',
						extra: '{{data.form.salerTaxNo}}'
					}, {
						name: 'address',
						component: '::div',
						className: 'm-inv-checkResult-phone',
						children: [{
							name: '销方地址、电话：',
							component: '::div',
							className: 'm-inv-checkResult-phoneLeft',
							children: '销方地址、电话：'
						}, {
							name: '销方地址、电话：',
							component: '::div',
							className: 'm-inv-checkResult-phoneRight',
							children: '{{data.form.salerAddressPhone}}'
						}]
					}]
				}]
			}]
			...
			name: 'nextBtn',
			component: 'Button',
			className: 'm-inv-checkResult-back',
			children: '检查下一张',
			onClick: '{{$goBackNext}}'
		}, {
			name: 'zhandi',
			component: '::div',
			className: 'm-inv-checkResult-zhandi',
			children: ''
		}] //waiceng
	};
}
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        var nowData = _this.component.props.data.result.channelInvoiceInfo;
        _this.metaAction.sfs({
            'data.form.invoiceType': nowData.invoiceType == '01' ? '增值税专用发票' : '增值税普通发票', //发票类型            
            'data.form.invoiceCode': nowData.invoiceCode, //发票代码
            'data.form.invoiceNo': nowData.invoiceNo, //发票号码
            'data.form.totalAmount': nowData.totalAmount, //价税合计
            'data.form.invoiceAmount': nowData.invoiceAmount, //发票金额
            'data.form.taxAmount': nowData.taxAmount, //发票税额
            'data.form.machineNo': nowData.machineNo, //机器编号
            'data.form.salerName': nowData.salerName, //销方名称
            'data.form.salerTaxNo': nowData.salerTaxNo, //销方税号：
            'data.form.salerAddressPhone': nowData.salerAddressPhone //销方地址.电话
        });
    };
    ...
    this.goBackNext = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _this.component.props.onOk({ a: 2 });
                        _mkUtils.history.goBack();
...
exports.default = {
    name: "m-inv-checkResult",
    version: "1.0.0",
    description: "m-inv-checkResult",
    meta: data.getMeta(),
    components: [],
    config: config,
