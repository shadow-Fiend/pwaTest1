...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-rpt-biz-balance-sheet',
		children: [{
			name: 'header',
			component: 'NavBar',
			mode: 'light',
			...
			name: 'chart',
			component: 'Echarts',
			_visible: '{{data.mode==\'chart\'}}',
			option: {
				series: [{
					type: 'pie',
					radius: ['50%', '70%'],
					animation: false,
					data: [{ value: 335, name: '资产' }, { value: 310, name: '负债' }, { value: 234, name: '所有者权益' }]
				}]
			}
		}, {
			name: 'list',
			component: 'List',
			_visible: '{{data.mode==\'list\'}}',
			children: [{
				name: 'zc',
				component: 'List.Item',
				extra: '111',
...
exports.default = {
    name: "m-rpt-biz-balance-sheet",
    version: "1.0.0",
    description: "m-rpt-biz-balance-sheet",
    meta: data.getMeta(),
    components: [],
    config: config,
...
function prefix(url) {
    return '' + (_config2.default.current.apiPrefix || 'v1') + url;
}

exports.default = {
    portal: {
        init: function init(option) {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['portal.init'], option);
        }
    },
    user: {
        logout: function logout() {
            return _mkUtils.fetch.post(_config2.default.current.webapiMap['user.logout']);
        }
    }
};
module.exports = exports['default'];
