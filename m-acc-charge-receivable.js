...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-acc-charge-receivable',
		children: [{
			name: 'list',
			component: 'List',
			className: 'm-acc-charge-receivable-list',
			children: [{
				name: 'date',
				component: 'List.Item',
				children: '入账日期',
				arrow: 'down',
				className: 'm-acc-charge-receivable-list-date',
				...
				arrow: 'down',
				children: '业务类型',
				className: "{{data.form.bizType && data.form.bizType.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				extra: '{{data.form.bizType ? data.form.bizType.name : "请选择"}}',
				onClick: "{{()=>$sf('data.showBizTypeModal', true)}}"
			}, {
				name: 'amount',
				component: 'InputItem',
				className: 'm-acc-charge-receivable-list-amount',
				type: 'digit',
				children: '金额',
				defaultValue: "0.00",
				...
				arrow: 'down',
				children: '账户',
				className: "{{data.form.account && data.form.account.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '商品或服务名称',
				className: "{{data.form.goods && data.form.goods.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '客户',
				className: "{{data.form.customer && data.form.customer.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '部门',
				className: "{{data.form.department && data.form.department.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '人员',
				className: "{{data.form.person && data.form.person.name ? 'm-acc-charge-receivable-list-date' : ''}}",
				...
				children: '备注',
				maxLength: 20,
				className: 'm-acc-charge-receivable-list-memo',
				onChange: "{{$memoChange}}",
				...
				name: 'more',
				component: '::div',
				className: 'm-acc-charge-receivable-list-more',
				children: [{
					name: 'goods',
					component: 'Tag',
			...
			name: 'footer',
			component: '::div',
			className: 'm-acc-charge-receivable-footer',
			children: [{
				name: 'saveAndNew',
				component: 'Button',
...
exports.default = {
    name: "m-acc-charge-receivable",
    version: "1.0.0",
    description: "m-acc-charge-receivable",
    meta: data.getMeta(),
    components: [],
    config: config,
