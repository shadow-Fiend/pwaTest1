...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_64__, __WEBPACK_EXTERNAL_MODULE_39__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_132__, __WEBPACK_EXTERNAL_MODULE_68__) {
...
var _options = {
	...
	webapiMap: {
		'account.queryBoardData': '/v1/app/acm/panels'
	}
};
...
var current = (0, _moment2.default)().format('YYYY-MM-DD'),
    currentYear = current.split('-')[0],
    currentMonth = current.split('-')[1],
    currentDay = current.split('-')[2],
    yesterday = (0, _moment2.default)().subtract(1, 'days').format('YYYY-MM-DD');

function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-acc-main',
		children: [{
			name: 'refresh',
			...
			children: [{
               ...
               component: 'WhiteSpace'
               },*/
				{
					name: 'nav',
					component: '::div',
					className: 'm-acc-main-nav',
					children: [{
						name: 'title',
						component: '::h2',
						_visible: false,
						children: '{{data.compony}}'
					}, getNavItem('thisMonth', '本月'), {
						name: 'whiteSpace',
						component: 'WhiteSpace'
					}]
				}, getListItem('today', '今日'), {
					name: 'whiteSpace',
					component: 'WhiteSpace'
				}, getListItem('yesterday1', '昨日'), {
					name: 'whiteSpace',
					component: 'WhiteSpace' /*,
                             getListItem('thisWeek', '本周'),
                             {
                             name: 'whiteSpace',
                             component: 'WhiteSpace',
                             },
                             getListItem('thisYear', '本年'),
                             {
                             name: 'whiteSpace',
                             component: 'WhiteSpace',
                             size: 'xl'
					...
					component: 'List.Item',
					// arrow: 'horizontal',
					className: 'm-acc-main-audit',
					extra: [{
						name: 'auditCircle',
						component: '::div',
						_visible: '{{!!data.toAudit && data.toAudit != "0"}}',
						className: 'm-acc-main-audit-auditCircle'
					}, '{{data.toAudit + \' \u7B14\'}}', {
						name: 'clickIcon',
						component: 'RRIcon',
						icon: 'jiantou-xiangyou'
					}],
					onClick: '{{()=>$openAccountList(\'unAudit\')}}',
					children: '待审核'
				}]
			}]
		}, {
			name: 'charge',
			component: 'Button',
			_visible: "{{data.currOrg && data.currOrg.industry == '1006' || false}}",
			children: '记一笔',
			className: 'm-acc-main-charge',
			onClick: '{{$openCharge}}'
		}]
	};
}

function getListItem(key, title) {
	return {
		name: key,
		component: 'List.Item',
		className: 'm-acc-main-middle',
		children: [{
			name: 'title',
			component: 'List.Item',
			className: 'm-acc-main-listNav',
			extra: ['{{data[\'' + key + '\'].month + \'\u6708\' + data[\'' + key + '\'].day + \'\u65E5\'}}', {
				name: 'clickIcon',
				component: 'RRIcon',
				icon: 'jiantou-xiangyou'
			}],
			// arrow: 'horizontal',
			onClick: '{{()=>$openAccountList(\'' + key + '\')}}',
			children: title
		}, {
			name: 'brief',
			component: 'List.Item.Brief',
			children: [{
				name: 'income',
				component: '::div',
				children: [{
					name: 'title',
					component: '::div',
					className: 'm-acc-main-listContentT',
					children: '收入'
				}, {
					name: 'money',
					component: '::div',
					className: 'm-acc-main-listContentIncome',
					children: '{{$numberFormat(data[\'' + key + '\'].income)}}'
				}]
			}, {
				name: 'payment',
				component: '::div',
				className: 'm-acc-main-listContentTP',
				children: [{
					name: 'title',
					component: '::div',
					className: 'm-acc-main-listContentT',
					...
					name: 'money',
					component: '::div',
					className: 'm-acc-main-listContentPayment',
					children: '{{$numberFormat(data[\'' + key + '\'].payment)}}'
				}]
			}, {
				name: 'balance',
				component: '::div',
				children: [{
					...
					name: 'money',
					component: '::div',
					className: 'm-acc-main-listContentBalance',
					children: '{{ $numberFormat(data[\'' + key + '\'].balance)}}'
				}]
			}]
		}]
	};
	...
	return {
		...
		children: [{
			...
			children: [{
				name: 'thisMonth',
				component: '::div',
				className: 'm-acc-main-nav-thisMonth',
				children: title
			}, {
				name: 'thisMonthData',
				component: '::div',
				className: 'm-acc-main-nav-thisMonthData',
				children: '{{data.currentMonth + "/" + data.currentYear}}'
			}]
		}, {
			name: 'brief',
			component: 'List.Item.Brief',
			children: [{
				...
				name: 'payment',
				component: '::div',
				className: 'm-acc-main-listContentCenter',
				children: [{
					name: 'title',
					component: '::div',
					className: 'm-acc-main-listContentT',
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        var currOrg = _this.metaAction.context._context.currOrg || {},
            setStatusBarBg = _this.component.props.setStatusBarBg;

        setStatusBarBg && setStatusBarBg('#45B8FB');
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.next = 3;
                            return _this.webapi.account.queryBoardData();
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            filter = data.filter, pagination = data.pagination;
    ...
    this.openCharge = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
        var openPage, backData;
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 3:
                        _context4.next = 5;
                        return openPage('记一笔', 'm-acc-charge', { comeFrome: 'main' });
    ...
    this.numberFormat = function (v) {
        return _mkUtils.number.format(v, 2);
    };
...
var reducer = function reducer(option) {
    ...
    this.load = function (state, response, currOrg) {
        state = _this.metaReducer.sf(state, 'data.currOrg', (0, _immutable.fromJS)(currOrg));
        state = _this.metaReducer.sf(state, 'data.thisMonth', (0, _immutable.fromJS)({
            'income': response.currentMonthIncome,
            'payment': response.currentMonthpay,
            'balance': response.currentMonthSurplus
        }));
        state = _this.metaReducer.sf(state, 'data.today', (0, _immutable.fromJS)({
            'income': response.currentDayIncome,
            'payment': response.currentDayPay,
            'balance': response.currentDaySurplus,
            'day': response.currentDay,
            'month': response.currentMonth
        }));
        state = _this.metaReducer.sf(state, 'data.yesterday1', (0, _immutable.fromJS)({
            'income': response.yesterdayIncome,
            'payment': response.yesterdayPay,
            'balance': response.yesterdaySurplus,
            'day': response.yesterday ? response.yesterday.split('-')[2] : '',
            'month': response.yesterday ? response.yesterday.split('-')[1] : ''
        }));
        state = _this.metaReducer.sf(state, 'data.toAudit', response.toAudit);
        state = _this.metaReducer.sf(state, 'data.yesterday', response.yesterday);
        state = _this.metaReducer.sf(state, 'data.currentYear', response.currentYear);
        state = _this.metaReducer.sf(state, 'data.currentMonth', response.currentMonth);
        state = _this.metaReducer.sf(state, 'data.currentDay', response.currentDay);
        return state;
    };
...
exports.default = {
    name: "m-acc-main",
    version: "1.0.0",
    description: "m-acc-main",
    meta: data.getMeta(),
    components: [],
    config: config,
    load: function load(cb) {
        cb(__webpack_require__(46), __webpack_require__(58), __webpack_require__(65));
    }
};
module.exports = exports['default'];
...
exports.default = {
    account: {
        queryBoardData: function queryBoardData(option) {
            return _mkUtils.fetch.post(api('account.queryBoardData'), option);
        }
    }
...
function initMockData() {
    if (!mockData.accountBoardData) {
        mockData.accountBoardData = {
            "currentDayIncome": 215.53,
            "yesterdayPay": 0,
            "currentDaySurplus": 215.53,
            "yesterdayIncome": 0,
            "toAudit": 13,
            "currentMonth": "07",
            "yesterdaySurplus": 0,
            "currentYear": "2018",
            "currentMonthpay": 2157.28,
            "yesterday": "2018-07-22",
            "currentDayPay": 0,
            "currentMonthSurplus": 9813.58,
            "currentDay": "23",
            "currentMonthIncome": 11970.86
        };
    }
}

_mkUtils.fetch.mock('/v1/app/acm/panels', function (option) {
    initMockData();

    return { result: true, value: mockData.accountBoardData };
});
