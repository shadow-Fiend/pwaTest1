...
// let currentMoment = moment().get('year')+'年1季度'
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		...
		children: [{
			...
			children: [{
				...
				children: [{
					name: 'taxWrapper',
					component: '::div',
					className: 'taxWrapper',
					children: '{{$getTaxSeries(data.taxData)}}'
				}]
			}, {
				name: 'dataTermsModal',
				component: 'Modal',
				...
				className: 'm-rpt-tax-DatePicker',
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        var currOrg = _this.metaAction.context._context.currOrg || {};
        _this.load(currOrg);
    };

    this.load = function () {
        var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(currOrg) {
            var timesArr;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 5:
                            if (currOrg) {
                                _this.taxLoad(undefined, timesArr, undefined, currOrg);
                            } else {
                                _this.taxLoad(undefined, timesArr);
                            }
                            _context.next = 9;
                            break;
    ...
    this.onRefresh = function (filter) {
        return function () {
            var isRefresh = true;
            _this.taxLoad(filter, undefined, isRefresh);
        };
    };

    this.taxLoad = function () {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                            ...
                            _context2.next = 7;
                            return _this.webapi.Statement(filter);

                        case 7:
                            ajaxData = _context2.sent;

                            if (currOrg && currOrg.vatTaxpayer == 42) {
                                //42小规模41一般纳税人
                                _this.metaAction.sfs({
                                    'data.other.dataTermss': (0, _immutable.fromJS)([{ label: '按月查询', value: '02' }, { label: '按季查询', value: '03' }]),
                                    'data.time.dataLine': currentMoment,
                                    ...
                                    'data.time.dataTerms': '按月'
                                });
                            } else if (currOrg && currOrg.vatTaxpayer == 41) {
                                _this.metaAction.sfs({
                                    'data.other.dataTermss': (0, _immutable.fromJS)([{ label: '按月查询', value: '02' }]),
                                    'data.time.dataLine': currentMoment,
                                    // 'data.time.minDate':new Date(currOrg.enabledYear +'-'+currOrg.enabledMonth+'-1'),
                                    'data.time.minDate': new Date(parseFloat(currOrg.enabledYear), parseFloat(currOrg.enabledMonth), 1),
                                    'data.time.dataTerms': '按月'
                            ...
                            _this.metaAction.sfs({
                                ...
                                'data.taxData': ajaxData.resultList
                            });
    ...
    this.getTaxSeries = function (data) {
        var taxArr = [];
        ...
        return { _isMeta: true, value: taxArr };
    };
...
__webpack_require__.p = window["__pub_m-rpt-tax__"];
...
exports.default = {
    Statement: function Statement(option) {
        return _mkUtils.fetch.post(api('Statement'), option);
    }
};
module.exports = exports['default'];
