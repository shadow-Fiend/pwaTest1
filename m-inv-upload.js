...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_66__, __WEBPACK_EXTERNAL_MODULE_42__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_60__, __WEBPACK_EXTERNAL_MODULE_137__) {
...
var _options = {
	...
	webapiMap: {
		'upload': '/v1/invoice/insert',
		'getPersonDeptList': '/v1/person/getPersonDeptList',
		// 'upPic': '/v1/invoice/uploadMobile'
		'upPic': '/v1/invoice/upload?type=2',
		'deletePic': '/v1/accountsIdentity/delete'
...
function getMeta() {
	return {
		...
		children: [{
			...
			name: 'content',
			component: '::div',
			className: 'm-inv-upload-content',
			children: [{
				name: 'bizType',
				component: 'List.Item',
				arrow: 'down',
				children: '票据类型',
				extra: '{{data.form.invType ? data.form.invType :"请选择票据类型"}}',
				...
				arrow: 'down',
				children: '报销人',
				extra: '{{data.form.people ? data.form.people :"请选择报销人"}}',
				onClick: '{{$peopleSelectClick(\'people\')}}'
			}, {
				name: 'allMoney',
				component: 'InputItem',
				children: '总金额',
				placeholder: '请输入金额',
				maxLength: '13',
				value: '{{data.form.allMoney}}',
				onBlur: "{{(v)=>$sf('data.form.allMoney', !!v && v != '-' ? parseFloat(v).toFixed(2).toString() : '0.00')}}",
				onFocus: "{{(v)=>$sf('data.form.allMoney', parseFloat(v) || '')}}",
				...
				children: '备注',
				placeholder: '请填写备注信息',
				onChange: "{{(v)=>$sf('data.form.note', v)}}",
				maxLength: '20',
			...
			name: 'btn',
			component: '::div',
			className: 'm-inv-upload-btn',
			children: {
				name: 'checking',
				component: 'Button',
				className: 'm-inv-upload-checking',
				children: '上传',
			...
			children: {
				...
				children: {
					...
					key: '{{data.other.invTypes[_rowIndex].value}}',
					onChange: '{{()=>$invTypeChange(data)(data.other.invTypes[_rowIndex].value)}}',
					children: '{{data.other.invTypes[_rowIndex].label}}',
					_power: 'for in data.other.invTypes'
				}
			}
		}, {
			name: 'peopleModal',
			...
			animationType: 'slide-up',
			popup: true,
			visible: '{{data.showPeopleModal}}',
			onClose: '{{()=>$sf(\'data.showPeopleModal\', false)}}',
			children: {
				name: 'list',
				component: 'List',
				children: {
					name: 'option',
					component: 'Radio.RadioItem',
					onChange: '{{()=>$peopleChange(data)(data.other.peopleName[_rowIndex].name)}}',
					children: '{{data.other.peopleName[_rowIndex].name}}',
					_power: 'for in data.other.peopleName'
				}
			}
		}, {
			name: 'paiModal',
...
exports.default = {
    upload: function upload(option) {
        return _mkUtils.fetch.post(api('upload'), option);
    },
    getPersonDeptList: function getPersonDeptList() {
        return _mkUtils.fetch.post(api('getPersonDeptList'), {});
    },
    upPic: function upPic(option) {
        return _mkUtils.fetch.post(api('upPic'), { imgStr: option });
    },
    deletePic: function deletePic(option) {
        return _mkUtils.fetch.post(api('deletePic'), { imgStr: option });
    },
    getUrl: api
};
module.exports = exports['default'];
...
, _initialiseProps = function _initialiseProps() {
    ...
    this.goBack = function () {
        _this.component.props.onOk({ a: 1 });
    ...
    this.invTypeChange = function (data) {
        return function (v) {
            var invType = data.other.invTypes.find(function (o) {
                return o.value == v;
            });

            _this.metaAction.sfs({
                'data.showBizTypeModal': false,
                'data.form.invType': invType.label,
                'data.form.invoiceType': invType.value
            });
        };
    };

    this.peopleSelectClick = function (type) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _this.metaAction.sf('data.showPeopleModal', true);
                            _context.next = 3;
                            return _this.webapi.getPersonDeptList();

                        case 3:
                            response = _context.sent;

                            _this.metaAction.sf('data.other.peopleName', (0, _immutable.fromJS)(response));
    ...
    this.peopleChange = function (data) {
        return function (v) {
            var people = data.other.peopleName.find(function (o) {
                return o.name == v;
            });
            console.log(people);

            _this.metaAction.sfs({
                'data.showPeopleModal': false,
                'data.form.people': people.name,
                'data.form.peopleType': people.id
            });
        };
    };
    ...
    this.getCheckDis = function (data) {
        ...
        if (info && info.get('invType') && info.get('people') && info.get('allMoney') && info.get('note') && info.get('paiPic').size) {
            return false;
        }
        return true;
    };

    this.invoiceUpload = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var nowData, imgIds, note, upData, response;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        nowData = _this.metaAction.gf('data.form').toJS(), imgIds = _this.metaAction.gf('data.form.paiPic').toJS().map(function (e) {
                            return e.id;
                        }), note = _this.metaAction.gf('data.form.note');
                        upData = {
                            "employee": nowData.peopleType,
                            "documentType": nowData.invoiceType,
                            "memo": nowData.note,
                            "amount": nowData.allMoney,
                            "enclosureIds": imgIds
                        };
                        _context2.next = 4;
                        return _this.webapi.upload(upData);

                    case 4:
                        response = _context2.sent;

                        _this.metaAction.toast('info', '上传成功！');
                        response && _this.goBack();
    ...
    this.changeMoney = function (data) {
        return function (v) {
            if (parseFloat(v) > 999999999.99 || parseFloat(v) < -999999999.99) {
                _this.metaAction.sf('data.form.allMoney', data.form.allMoney);
            } else if (!parseFloat(v) && v != '-') {
                _this.metaAction.sf('data.form.allMoney', '');
            } else if (!parseFloat(v) && v == '-') {
                _this.metaAction.sf('data.form.allMoney', '-');
            } else {
                _this.metaAction.sf('data.form.allMoney', v);
            }
        };
    };
    ...
    this.handleImageChange = function () {
        var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(files, operationType, index) {
            var paiPic, response;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 4;
                            return _this.webapi.deletePic(paiPic[index].newName);
    ...
    this.handleImageClick = function (index, files) {
        //debugger
        window.PhotoViewer && window.PhotoViewer.show(files[index].url, files[index].oldName);
    };

    this.getPicture = function (option) {
        window.camera.getPicture(function () {
            var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(fileURL) {
                var options, ft, SERVER, success, fail;
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                options = new window.FileUploadOptions(), ft = new window.FileTransfer(), SERVER = _webapi2.default.getUrl('upPic');
    ...
    this.getPhoto = function () {
        var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(files, type, index) {
            var response;
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            ...
                            _context5.next = 4;
                            return _this.webapi.upPic(files[0].url);
