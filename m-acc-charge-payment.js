...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-acc-charge-payment',
		children: [{
			name: 'list',
			component: 'List',
			className: 'm-acc-charge-payment-list',
			children: [{
				name: 'date',
				component: 'List.Item',
				children: '入账日期',
				arrow: 'down',
				className: 'm-acc-charge-payment-list-date',
				...
				arrow: 'down',
				children: '业务类型',
				className: "{{data.form.bizType && data.form.bizType.name ? 'm-acc-charge-payment-list-date' : ''}}",
				extra: '{{data.form.bizType ? data.form.bizType.name : "请选择"}}',
				onClick: "{{()=>$sf('data.showBizTypeModal', true)}}"
			}, {
				name: 'amount',
				component: 'InputItem',
				className: 'm-acc-charge-payment-list-amount',
				type: 'digit',
				children: '金额',
				defaultValue: "0.00",
				...
				arrow: 'down',
				children: '账户',
				className: "{{data.form.account && data.form.account.name ? 'm-acc-charge-payment-list-date' : ''}}",
				...
				arrow: 'down',
				children: '商品或服务名称',
				className: "{{data.form.goods && data.form.goods.name ? 'm-acc-charge-payment-list-date' : ''}}",
				...
				arrow: 'down',
				children: '部门',
				className: "{{data.form.department && data.form.department.name ? 'm-acc-charge-payment-list-date' : ''}}",
				...
				arrow: 'down',
				children: '人员',
				className: "{{data.form.person && data.form.person.name ? 'm-acc-charge-payment-list-date' : ''}}",
				...
				children: '备注',
				maxLength: 20,
				className: 'm-acc-charge-payment-list-memo',
				onChange: "{{$memoChange}}",
				...
				name: 'more',
				component: '::div',
				className: 'm-acc-charge-payment-list-more',
				children: [{
					name: 'goods',
					component: 'Tag',
			...
			name: 'footer',
			component: '::div',
			className: 'm-acc-charge-payment-footer',
			children: [{
				name: 'saveAndNew',
				component: 'Button',
...
exports.default = {
    name: "m-acc-charge-payment",
    version: "1.0.0",
    description: "m-acc-charge-payment",
    meta: data.getMeta(),
    components: [],
    config: config,
