(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("MK.metaEngine"), require("react"), require("MK.utils"), require("echarts"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "MK.metaEngine", "react", "MK.utils", "echarts"], factory);
	else if(typeof exports === 'object')
		exports["MCommon"] = factory(require("immutable"), require("MK")["metaEngine"], require("react"), require("MK.utils"), require("echarts"));
	else
		root["MCommon"] = factory(root["Immutable"], root["MK.metaEngine"], root["React"], root["MK"]["utils"], root["echarts"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_126__, __WEBPACK_EXTERNAL_MODULE_36__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_56__, __WEBPACK_EXTERNAL_MODULE_54__) {
...
var _webapi = __webpack_require__(122);
...
var _mkMetaEngine = __webpack_require__(36);
...
var _mkIcon = __webpack_require__(62);

var _mkIcon2 = _interopRequireDefault(_mkIcon);

var _countDown = __webpack_require__(72);

var _countDown2 = _interopRequireDefault(_countDown);

var _echarts = __webpack_require__(107);

var _echarts2 = _interopRequireDefault(_echarts);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

__webpack_require__.p = window["__pub_common__"];
...
MK && MK.metaEngine.componentFactory.registerComponent('Echarts', _echarts2.default, true);
MK && MK.metaEngine.componentFactory.registerComponent('RRIcon', _mkIcon2.default, true);
MK && MK.metaEngine.componentFactory.registerComponent('CountDown', _countDown2.default, true);

exports.default = {
    name: "m-common",
    version: "1.0.0",
    description: "m-common",
    meta: data.getMeta(),
    components: [],
    config: config,
    load: function load(cb) {
        cb(__webpack_require__(57), __webpack_require__(58), __webpack_require__(59));
    }
};
module.exports = exports['default'];
...
exports.default = RRIconComponent;
...
function RRIconComponent(props) {
    var _props$colorStyle = props.colorStyle,
        colorStyle = _props$colorStyle === undefined ? 'default' : _props$colorStyle,
        icon = props.icon,
        _props$shape = props.shape,
        shape = _props$shape === undefined ? 'default' : _props$shape,
        disabled = props.disabled,
        _props$className = props.className,
        className = _props$className === undefined ? '' : _props$className,
        onClick = props.onClick,
        otherProps = (0, _objectWithoutProperties3.default)(props, ['colorStyle', 'icon', 'shape', 'disabled', 'className', 'onClick']);

    var shapeName = 'rriconfont--',
        ext = {};

    if (!disabled && onClick) ext.onClick = onClick;

    if (disabled) shapeName = '' + shapeName + shape + '-disabled';else shapeName = '' + shapeName + colorStyle + '-' + shape;

    var classString = 'rriconfont ' + shapeName + ' ' + className + ' rriconfont-' + icon;

    return React.createElement('i', (0, _extends3.default)({ className: classString }, otherProps, ext));
}
module.exports = exports['default'];
...
var CountDownComponent = (_temp = _class = function (_Component) {
    (0, _inherits3.default)(CountDownComponent, _Component);

    function CountDownComponent(props) {
        (0, _classCallCheck3.default)(this, CountDownComponent);

        var _this = (0, _possibleConstructorReturn3.default)(this, (CountDownComponent.__proto__ || (0, _getPrototypeOf2.default)(CountDownComponent)).call(this, props));
    ...
    (0, _createClass3.default)(CountDownComponent, [{
        key: 'handleClick',
        value: function handleClick(e) {
            ...
            var setTime = function setTime() {
                var currentCount = _this2.state.currentCount;
                if (currentCount == -1) {
                    _this2.setState({ currentCount: 0 });
                    return;
                }

                currentCount = currentCount > 0 ? currentCount - 1 : _this2.props.count;

                _this2.setState({ currentCount: currentCount });
                if (currentCount > 0) timer = setTimeout(setTime, 1000);
            };
        ...
        value: function render() {
            var currentCount = this.state.currentCount,
                ...
                text = disabled ? currentCount + '\u79D2' : this.props.text,
            ...
            return _react2.default.createElement(
                'span',
                { type: type, style: this.props.style, disabled: disabled, onClick: this.handleClick.bind(this) },
                text
            );
        }
    }]);
...
__webpack_require__(6)(IteratorPrototype, __webpack_require__(11)('iterator'), function () { return this; });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(38)(Function.call, __webpack_require__(52).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _echartsForReact = __webpack_require__(108);
...
var _fastDeepEqual = __webpack_require__(115);

var _fastDeepEqual2 = _interopRequireDefault(_fastDeepEqual);

var _sizeSensor = __webpack_require__(116);
...
var _sensorPool = __webpack_require__(117);
...
var _id = __webpack_require__(118);

var _id2 = _interopRequireDefault(_id);

var _Sensor = __webpack_require__(119);
...
var getSensor = exports.getSensor = function getSensor(element) {
  ...
  var sensor = new _Sensor.Sensor(element);
  // 添加到池子中
...
var _mkUtils = __webpack_require__(56);
