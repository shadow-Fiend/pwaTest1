(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("MK.metaEngine"), require("react"), require("react-dom"), require("MK.utils"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "MK.metaEngine", "react", "react-dom", "MK.utils"], factory);
	else if(typeof exports === 'object')
		exports["MSysLogin"] = factory(require("immutable"), require("MK")["metaEngine"], require("react"), require("react-dom"), require("MK.utils"));
	else
		root["MSysLogin"] = factory(root["Immutable"], root["MK.metaEngine"], root["React"], root["ReactDOM"], root["MK"]["utils"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_137__, __WEBPACK_EXTERNAL_MODULE_41__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_133__, __WEBPACK_EXTERNAL_MODULE_47__) {
...
var _options = {
	...
	goAfterPortal: {
		appName: 'm-sys-portal',
		appParams: {}
	},
	goForgetPassword: {
		appName: 'm-sys-forgetPassword',
		appParams: {}
	}
};
...
function getMeta() {
	return {
		...
		component: 'Flex',
		direction: 'column',
		className: 'm-sys-login',
		alignContent: 'center',
		children: [{
			name: 'header',
			component: '::div',
			className: 'm-sys-login-header',
			children: '登录'
		}, {
			name: 'content',
			component: 'Flex.Item',
			className: 'm-sys-login-content',
			children: [{
				name: 'account',
				component: 'List',
				children: [{
				...
				children: [{
					...
					extra: [{
						name: 'user',
						component: 'RRIcon',
						icon: '{{data.isShowOldPassword ? \'mima-xianshi-zhengyan\' : \'mima-buxianshi-biyan\'}}'
					}],
					maxLength: 20,
					onExtraClick: "{{(v)=>$sf('data.isShowOldPassword', !data.isShowOldPassword)}}",
					placeholder: '6-20位且同时包含字母和数字',
					onVirtualKeyboardConfirm: "{{(v)=>$sf('data.form.password', v)}}",
				...
				name: 'forgetPassword',
				component: '::div',
				className: 'm-sys-login-forgetPassword',
				children: '忘记密码？',
			...
			name: 'footer',
			component: '::div',
			className: 'm-sys-login-footer',
			children: '客服电话：400-6060-386'
		}]
	};
}
...
var _mkMetaEngine = __webpack_require__(41);
...
var _md = __webpack_require__(134);
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        setStatusBarBg && setStatusBarBg('#E8F4FF');
        setStatusBottomCorol && setStatusBottomCorol('#E8F4FF');
    ...
    this.login = function (data) {
        return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var form, ok, error, message, pwd, response;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            if (!(window.Connection && window.navigator.connection.type == window.Connection.NONE)) {
                                _context.next = 3;
                                break;
                            }

                            return _context.abrupt('return', _this.metaAction.toast('error', '网络异常，请稍后再试!'));

                        case 3:
                            _context.next = 5;
                            return _this.check([{
                                path: 'data.form.account', value: form.account
                            }, {
                        ...
                        case 5:
                            ...
                            error = _this.metaAction.gf('data.other.error'), message = [];

                            if (error.get('account')) {
                                message = error.get('account');
                            }
                            if (error.get('password')) {
                                message = error.get('password');
                            }
                            if (error.get('account') && error.get('password')) {
                                message = '请录入手机号和密码';
                            }
                            return _context.abrupt('return', _this.metaAction.toast('error', message));

                        case 12:
                            pwd = form.password;

                            if (pwd) {
                                pwd = (0, _md2.default)(pwd + 'yiJia9*');
                            } else {
                                pwd = localStorage.getItem('password');
                            }
                            _context.next = 16;
                            return _this.webapi.login({
                        ...
                        case 16:
                            ...
                            if (response) {
                                // this.metaAction.context.set('currentUser', response.sysUser)
                                localStorage.setItem('account', form.account);
                                localStorage.setItem('password', pwd);
                                localStorage.setItem('remember', true);
                                if (_this.component.props.onRedirect && _this.config.goAfterPortal) {
                                    _this.component.props.onRedirect(_this.config.goAfterPortal);
                                }
                            } else {
                                _this.metaAction.sfs({
                                    'data.form.password': ''
                                });
                                // this.metaAction.toast('error', '目前移动端只支持餐饮行业，其他行业敬请期待')
                            }
    ...
    this.goForgetPassword = function () {
        ...
        if (_this.component.props.onRedirect && _this.config.goForgetPassword) {
            _this.component.props.onRedirect(_this.config.goForgetPassword);
        }
    };
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 8:
                            ...
                            _context3.t1 = r;
                            _context3.next = 16;
                            return _this.checkUser(o.value);
    ...
    this.checkUser = function () {
        var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(user) {
            var message;
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            if (!user) message = '请录入手机号';else if (!/^[1][0-9][0-9]{9}$/.test(user)) message = '请录入有效的手机号';

                            return _context4.abrupt('return', { errorPath: 'data.other.error.account', message: message });
...
var reducer = (_temp = _class = function reducer(option) {
    ...
    this.init = function (state, option) {
        ...
        s.data.form = (0, _extends3.default)({}, s.data.form, option);
...
__webpack_require__.p = window["__pub_login__"];
...
exports.default = {
    name: "m-sys-login",
    version: "1.0.0",
    description: "m-sys-login",
    meta: data.getMeta(),
    components: [],
    config: config,
    load: function load(cb) {
        cb(__webpack_require__(48), __webpack_require__(58), __webpack_require__(66));
    }
};
module.exports = exports['default'];
...
var _mkUtils = __webpack_require__(47);
...
var api = function api(key) {
    var url = _config2.default.current.webapiMap['login'],
        prefix = _config2.default.current.apiPrefix;

    return _mkUtils.fetch.isMockUrl && _mkUtils.fetch.isMockUrl(url) ? url : prefix ? '' + prefix + url : url;
};

exports.default = {
    login: function login(option) {
        return _mkUtils.fetch.post(api('login'), option);
    }
};
module.exports = exports['default'];
...
_mkUtils.fetch.mock('/v1/sys/login/login', function (option) {
    initMockData();
...
(function(){
  var crypt = __webpack_require__(135),
