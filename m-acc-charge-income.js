...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-acc-charge-income',
		children: [{
			name: 'list',
			component: 'List',
			className: 'm-acc-charge-income-list',
			children: [{
				name: 'date',
				component: 'List.Item',
				children: '入账日期',
				arrow: 'down',
				className: 'm-acc-charge-income-list-date',
				...
				arrow: 'down',
				children: '业务类型',
				className: "{{data.form.bizType && data.form.bizType.name ? 'm-acc-charge-income-list-date' : ''}}",
				extra: '{{data.form.bizType ? data.form.bizType.name : "请选择"}}',
				onClick: "{{()=>$sf('data.showBizTypeModal', true)}}"
			}, {
				name: 'amount',
				component: 'InputItem',
				className: 'm-acc-charge-income-list-amount',
				// type: 'preice',
				type: 'digit',
				children: '金额',
				defaultValue: "0.00",
				...
				arrow: 'down',
				children: '账户',
				className: "{{data.form.account && data.form.account.name ? 'm-acc-charge-income-list-date' : ''}}",
				...
				arrow: 'down',
				children: '商品或服务名称',
				className: "{{data.form.goods && data.form.goods.name ? 'm-acc-charge-income-list-date' : ''}}",
				...
				arrow: 'down',
				children: '客户',
				className: "{{data.form.customer && data.form.customer.name ? 'm-acc-charge-income-list-date' : ''}}",
				...
				arrow: 'down',
				children: '部门',
				className: "{{data.form.department && data.form.department.name ? 'm-acc-charge-income-list-date' : ''}}",
				...
				arrow: 'down',
				children: '人员',
				className: "{{data.form.person && data.form.person.name ? 'm-acc-charge-income-list-date' : ''}}",
				...
				children: '备注',
				maxLength: 20,
				className: 'm-acc-charge-income-list-memo',
				onChange: "{{$memoChange}}",
				...
				name: 'more',
				component: '::div',
				className: 'm-acc-charge-income-list-more',
				children: [{
					name: 'goods',
					component: 'Tag',
			...
			name: 'footer',
			component: '::div',
			className: 'm-acc-charge-income-footer',
			children: [{
				name: 'saveAndNew',
				component: 'Button',
...
var action = (_temp = _class = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        var comeFrome = component.props.comeFrome || '',
            info = component.props.info || {};

        _this.load(comeFrome, info.id);
    };

    this.load = function () {
        var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(comeFrome, id) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.next = 3;
                            return _this.webapi.addBiz.init({ id: id });
    ...
    this.getAccountList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
    ...
    this.getCustomerList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
        var businessCode, response;
        return _regenerator2.default.wrap(function _callee6$(_context6) {
            while (1) {
                switch (_context6.prev = _context6.next) {
                    ...
                    case 3:
                        _context6.next = 5;
                        return _this.webapi.addBiz.customer({ businessCode: businessCode });
...
exports.default = {
    name: "m-acc-charge-income",
    version: "1.0.0",
    description: "m-acc-charge-income",
    meta: data.getMeta(),
    components: [],
    config: config,
