...
function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'm-acc-charge-payable',
		children: [{
			name: 'list',
			component: 'List',
			className: 'm-acc-charge-payable-list',
			children: [{
				name: 'date',
				component: 'List.Item',
				children: '入账日期',
				arrow: 'down',
				className: 'm-acc-charge-payable-list-date',
				...
				arrow: 'down',
				children: '业务类型',
				className: "{{data.form.bizType && data.form.bizType.name ? 'm-acc-charge-payable-list-date' : ''}}",
				extra: '{{data.form.bizType ? data.form.bizType.name : "请选择"}}',
				onClick: "{{()=>$sf('data.showBizTypeModal', true)}}"
			}, {
				name: 'amount',
				component: 'InputItem',
				className: 'm-acc-charge-payable-list-amount',
				type: 'digit',
				children: '金额',
				defaultValue: "0.00",
				...
				arrow: 'down',
				children: '账户',
				className: "{{data.form.account && data.form.account.name ? 'm-acc-charge-payable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '商品或服务名称',
				className: "{{data.form.goods && data.form.goods.name ? 'm-acc-charge-payable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '供应商',
				className: "{{data.form.vendor && data.form.vendor.name ? 'm-acc-charge-payable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '部门',
				className: "{{data.form.department && data.form.department.name ? 'm-acc-charge-payable-list-date' : ''}}",
				...
				arrow: 'down',
				children: '人员',
				className: "{{data.form.person && data.form.person.name ? 'm-acc-charge-payable-list-date' : ''}}",
				...
				children: '备注',
				maxLength: 20,
				className: 'm-acc-charge-payable-list-memo',
				onChange: "{{$memoChange}}",
				...
				name: 'more',
				component: '::div',
				className: 'm-acc-charge-payable-list-more',
				children: [{
					name: 'goods',
					component: 'Tag',
					...
					name: 'vendor',
					component: 'Tag',
					selected: '{{data.moreVisible.vendor}}',
					onChange: '{{$moreOption(\'vendor\')}}',
					children: '供应商'
				}, {
					name: 'department',
					component: 'Tag',
			...
			name: 'footer',
			component: '::div',
			className: 'm-acc-charge-payable-footer',
			children: [{
				name: 'saveAndNew',
				component: 'Button',
...
var action = (_temp = _class = function action(option) {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 18:
                            ...
                            _context2.t0 = type;
                            _context2.next = _context2.t0 === 'new' ? 23 : 25;
                            break;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            return _context3.abrupt('return', _this.metaAction.toast('info', '请先选择业务类型'));
    ...
    this.getGoodsList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
        var businessCode, response;
        return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        businessCode = _this.metaAction.gf('data.form.bizType') ? _this.metaAction.gf('data.form.bizType').get('code') : '';
                    ...
                    case 3:
                        _context5.next = 5;
                        return _this.webapi.addBiz.inventory({ businessCode: businessCode });
    ...
    this.getVendorList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
        var businessCode, response;
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        ...
                        return _context6.abrupt('return', _this.metaAction.toast('info', '请先选择业务类型'));

                    case 3:
                        _context6.next = 5;
                        return _this.webapi.addBiz.vendor({ businessCode: businessCode });
    ...
    this.getDepartmentList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
        var businessCode, response;
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        ...
                        return _context7.abrupt('return', _this.metaAction.toast('info', '请先选择业务类型'));

                    case 3:
                        _context7.next = 5;
                        return _this.webapi.addBiz.department({ businessCode: businessCode });
    ...
    this.getPersonList = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {
        var businessCode, response;
        return _regenerator2.default.wrap(function _callee8$(_context8) {
            while (1) {
                switch (_context8.prev = _context8.next) {
                    ...
                    case 3:
                        _context8.next = 5;
                        return _this.webapi.addBiz.employee({ businessCode: businessCode });
    ...
    this.moreOption = function (type) {
        return function (v) {
            switch (type) {
                ...
                case 'vendor':
                    !v ? _this.metaAction.sfs({
                        'data.moreVisible.vendor': v,
                        'data.form.vendor': ''
                    }) : _this.metaAction.sf('data.moreVisible.vendor', v);
                    break;
                case 'department':
                    !v ? _this.metaAction.sfs({
    ...
    this.handleImageChange = function () {
        var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(files, operationType, index) {
            var paiPic;
    ...
    this.getPicture = function (option) {
        window.camera.getPicture(function () {
            var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(fileURL) {
    ...
    this.getPhoto = function () {
        var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(files, type, index) {
            var response;
    ...
    this.checkedFun = function (ret) {
        ...
        if (!ret.businessCode) {
            ...
            isContinue = false;
            _this.metaAction.toast('info', '账户不能为空');
        } else if (!ret.memo) {
            isContinue = false;
...
exports.default = {
    name: "m-acc-charge-payable",
    version: "1.0.0",
    description: "m-acc-charge-payable",
    meta: data.getMeta(),
    components: [],
    config: config,
