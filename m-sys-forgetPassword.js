(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("MK.metaEngine"), require("MK.utils"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "MK.metaEngine", "MK.utils", "react"], factory);
	else if(typeof exports === 'object')
		exports["MSysForgetPassword"] = factory(require("immutable"), require("MK")["metaEngine"], require("MK.utils"), require("react"));
	else
		root["MSysForgetPassword"] = factory(root["Immutable"], root["MK.metaEngine"], root["MK"]["utils"], root["React"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_132__, __WEBPACK_EXTERNAL_MODULE_39__, __WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_57__) {
...
var _webapi = __webpack_require__(73);
...
var _options = {
	...
	webapiMap: {
		'isExist': '/v1/user/isExist',
		'sendConfirmCode': '/v1/web/pub/sendConfirmCode',
		'isRightConfirmCode': '/v1/web/pub/isRightConfirmCode',
...
function getMeta() {
    return {
        ...
        children: [{
            name: 'header',
            component: 'WingBlank',
            className: 'forgetPassword-header',
            children: [{
                name: 'Icon',
                component: 'RRIcon',
                ...
                name: 'title',
                component: '::div',
                className: 'forgetPassword-header-title',
                children: '找回密码'
            }]
        }, {
            name: 'content',
            component: 'Flex.Item',
            className: 'forgetPassword-content',
            children: [{
                name: 'account',
                component: 'List',
                children: [{
                    ...
                    labelNumber: 2,
                    onChange: "{{(v)=>$sf('data.form.account', v)}}",
                ...
                children: [{
                    ...
                    extra: [{
                        ...
                        component: 'CountDown',
                        text: '验证码',
                        onClick: '{{$sendCaptcha(data)}}',
                        count: 120
                    }],
                    placeholder: '验证码',
                    onChange: "{{(v)=>$sf('data.form.captcha', v)}}",
                ...
                children: [{
                    ...
                    extra: [{
                        name: 'user',
                        component: 'RRIcon',
                        icon: '{{data.isShowPassword ? \'mima-xianshi-zhengyan\' : \'mima-buxianshi-biyan\'}}'
                    }],
                    onVirtualKeyboardConfirm: "{{$handleModifyPassword}}",
                    placeholder: '6-20位且同时包含字母和数字',
                    maxLength: 20,
                    onExtraClick: "{{(v)=>$sf('data.isShowPassword', true)}}",
                    labelNumber: 2,
                    onChange: "{{(v)=>$sf('data.form.password', v)}}",
                ...
                children: [{
                    ...
                    placeholder: '6-20位且同时包含字母和数字',
                    maxLength: 20,
                    onExtraClick: "{{(v)=>$sf('data.isShowPassword', false)}}",
                    labelNumber: 2,
                    onChange: "{{(v)=>$sf('data.form.password', v)}}",
                    value: '{{data.form.password}}'
                }]
                ...
                children: '重置密码',
                width: 294,
                onClick: "{{$handleModifyPassword(data)}}"
            }]
        }]
    };
}
...
var _mkUtils = __webpack_require__(33);

var _data = __webpack_require__(16);

var _md = __webpack_require__(129);
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        initState.data.account = localStorage.getItem('account') || '';
        _this.component.props.setStatusBarBg('#E8F4FF');
        injections.reduce('init', { initState: initState });
    };

    this.goLogin = function () {
        if (_this.component.props.onRedirect && _this.config.goLogin) {
            _this.component.props.onRedirect(_this.config.goLogin);
        }
    };

    this.sendCaptcha = function (data) {
        return function () {
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(cb) {
                var checkUserRes, res;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _this.metaAction.toast('error', '请输入手机号');
                                return _context.abrupt('return', cb());

                            case 3:
                                if (/^[1][0-9][0-9]{9}$/.test(data.form.account)) {
                                    _context.next = 6;
                                    break;
                                }

                                _this.metaAction.toast('error', '请输入正确格式的手机号');
                                return _context.abrupt('return', cb());

                            case 6:
                                _context.next = 8;
                                return _this.webapi.isExist({ account: data.form.account });

                            case 8:
                                checkUserRes = _context.sent;
                                ...
                                _context.next = 12;
                                return _this.webapi.sendConfirmCode({ account: data.form.account, codeType: 2 });

                            case 12:
                                res = _context.sent;

                                res && _this.metaAction.sfs({
                                    'data.form.md5Code': res.md5Code,
                                    'data.form.ts': res.ts,
                            ...
                            case 16:
                                _this.metaAction.toast('error', '当前账户不存在');
                                return _context.abrupt('return', cb());
    ...
    this.handleModifyPassword = function (data) {
        return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
            var form, pwdReg, passwordStrength, appId, res, postObj, resetRes;
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            form = data.form, pwdReg = new RegExp('(?=^.{6,20}$)((?=.*[a-zA-Z]){1})((?=.*[0-9]){1})'), passwordStrength = 0, appId = data.userInfo && data.userInfo.sysApp.id;
                            ...
                            return _context2.abrupt('return', _this.metaAction.toast('error', '请输入验证码'));
                        ...
                        case 3:
                            ...
                            return _context2.abrupt('return', _this.metaAction.toast('error', '请输入正确格式的密码'));

                        case 5:
                            // 密码强度 密码强度(0:弱1：中2：强)
                            if (form.password.length < 6 || /^(?:\d+|[a-zA-Z]+|[!@#$%^&*]+)$/.test(form.password)) {
                                passwordStrength = 0;
                            } else if (form.password.length < 12 || /^((?![a-zA-Z]+$)(?![@#$%^&]+$)[a-zA-Z@#$%^&]+)$|((?!\d+$)(?![a-zA-Z]+$)[a-zA-Z\d]+)$/.test(form.password)) {
                                passwordStrength = 1;
                            } else if (form.password.length >= 12 || /^(?!\d+$)(?![a-zA-Z]+$)(?![@#$%^&]+$)[\da-zA-Z@#$%^&]+$/.test(form.password)) {
                                passwordStrength = 2;
                            }
                            _context2.next = 8;
                            return _this.webapi.isRightConfirmCode({ 'confirmCode': form.captcha, 'ts': form.ts, 'account': form.account, 'md5Code': form.md5Code });

                        case 8:
                            res = _context2.sent;
                            postObj = {
                                "confirmCode": form.captcha + ',' + form.ts + ',' + form.md5Code,
                                "account": form.account,
                                "password": (0, _md2.default)(form.password + 'yiJia9*'),
                            ...
                            _context2.next = 13;
                            return _this.webapi.resetPassword(postObj);

                        case 13:
                            resetRes = _context2.sent;

                            localStorage.setItem('account', resetRes);
                            localStorage.setItem('password', '');

                        case 16:
                            _this.metaAction.toast('success', '密码重置成功，请重新登录');
                            if (_this.component.props.onRedirect && _this.config.goLogin) {
                                _this.component.props.onRedirect(_this.config.goLogin);
                            }
...
var _immutable = __webpack_require__(132);
...
__webpack_require__.p = window["__pub_forgetPassword__"];
...
exports.default = {
    name: "m-sys-forgetPassword",
    version: "1.0.0",
    description: "m-sys-forgetPassword",
    meta: data.getMeta(),
    components: [],
    config: config,
...
exports.default = {
    isExist: function isExist(option) {
        return _mkUtils.fetch.post(api('isExist'), option);
    }, //检测帐户是否存在
    sendConfirmCode: function sendConfirmCode(option) {
        return _mkUtils.fetch.post(api('sendConfirmCode'), option);
    }, // 发送验证码 codeType:1-注册 2-找回密码 3-绑定手机或邮箱
    isRightConfirmCode: function isRightConfirmCode(option) {
        return _mkUtils.fetch.post(api('isRightConfirmCode'), option);
    }, // 校验验证码是否正确
    resetPassword: function resetPassword(option) {
        return _mkUtils.fetch.post(api('resetPassword'), option);
    }
};
module.exports = exports['default'];
...
(function(){
  var crypt = __webpack_require__(130),
