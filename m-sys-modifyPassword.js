(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MSysModifyPassword"] = factory(require("immutable"), require("MK")["metaEngine"], require("MK.utils"), require("react"));
	else
		root["MSysModifyPassword"] = factory(root["Immutable"], root["MK.metaEngine"], root["MK"]["utils"], root["React"]);
...
function getMeta() {
    return {
        ...
        children: [{
            name: 'header',
            component: 'WingBlank',
            className: 'modifyPassword-header',
            children: [{
                name: 'Icon',
                component: 'RRIcon',
                ...
                name: 'title',
                component: '::div',
                className: 'modifyPassword-header-title',
                children: '修改密码'
            }]
        }, {
            name: 'content',
            component: 'Flex',
            className: 'modifyPassword-content',
            children: [{
                name: 'oldPassword',
                component: 'List',
                children: [{
                    ...
                    labelNumber: 2,
                    onChange: "{{(v)=>$sf('data.form.oldPassword', v)}}",
                ...
                children: [{
                    ...
                    maxLength: 20,
                    onExtraClick: "{{(v)=>$sf('data.isShowPassword', !data.isShowPassword)}}",
                    labelNumber: 2,
                    onVirtualKeyboardConfirm: "{{(v)=>$sf('data.form.newpassword', v)}}",
                    onChange: "{{(v)=>$sf('data.form.newpassword', v)}}",
                ...
                type: 'primary',
                children: '修改密码',
                onClick: "{{$handleModifyPassword(data.form)}}"
            }]
        }]
    };
}
...
var action = function action(option) {
    ...
    this.goPortal = function () {
        if (_this.component.props.onRedirect && _this.config.goPortal) {
            _this.component.props.onRedirect(_this.config.goPortal);
        }
    };

    this.handleModifyPassword = function (data) {
        return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var pwdStrength, pwdReg, postObj, res;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            pwdStrength = 0, pwdReg = new RegExp('(?=^.{6,20}$)((?=.*[a-zA-Z]){1})((?=.*[0-9]){1})');
                            ...
                            return _context.abrupt('return', _this.metaAction.toast('error', '请输入您的旧密码'));
                        ...
                        case 3:
                            ...
                            return _context.abrupt('return', _this.metaAction.toast('error', '新密码不允许为空'));
                        ...
                        case 5:
                            ...
                            return _context.abrupt('return', _this.metaAction.toast('error', '请输入正确格式的密码'));

                        case 7:
                            // 密码强度 密码强度(0:弱1：中2：强)
                            if (data.newpassword.length < 6 || /^(?:\d+|[a-zA-Z]+|[!@#$%^&*]+)$/.test(data.newpassword)) {
                                pwdStrength = 0;
                            } else if (data.newpassword.length < 12 || /^((?![a-zA-Z]+$)(?![@#$%^&]+$)[a-zA-Z@#$%^&]+)$|((?!\d+$)(?![a-zA-Z]+$)[a-zA-Z\d]+)$/.test(data.newpassword)) {
                                pwdStrength = 1;
                            } else if (data.newpassword.length >= 12 || /^(?!\d+$)(?![a-zA-Z]+$)(?![@#$%^&]+$)[\da-zA-Z@#$%^&]+$/.test(data.newpassword)) {
                                pwdStrength = 2;
                            }
                            postObj = {
                                'password': (0, _md2.default)(data.oldPassword + 'yiJia9*'),
                                'npassword': (0, _md2.default)(data.newpassword + 'yiJia9*'),
                                'passwordStrength': pwdStrength
                            };
                            _context.next = 11;
                            return _this.webapi.updatePassword(postObj);

                        case 11:
                            res = _context.sent;

                            localStorage.setItem('password', postObj.npassword);
                            _this.metaAction.toast('success', '密码修改成功！');
                            if (_this.component.props.onRedirect && _this.config.goPortal) {
                                _this.component.props.onRedirect(_this.config.goPortal);
                            }
...
__webpack_require__.p = window["__pub_modifyPassword__"];
...
exports.default = {
    name: "m-sys-modifyPassword",
    version: "1.0.0",
    description: "m-sys-modifyPassword",
    meta: data.getMeta(),
    components: [],
    config: config,
...
exports.default = {
    updatePassword: function updatePassword(option) {
        return _mkUtils.fetch.post(api('updatePassword'), option);
    }
};
module.exports = exports['default'];
