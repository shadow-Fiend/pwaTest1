...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_56__, __WEBPACK_EXTERNAL_MODULE_38__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_54__, __WEBPACK_EXTERNAL_MODULE_115__, __WEBPACK_EXTERNAL_MODULE_39__) {
...
var _webapi = __webpack_require__(67);
...
function getMeta() {
	return {
		...
		children: [{
			...
			name: 'content',
			component: '::div',
			className: 'm-inv-details-content',
			children: [{
				name: 'list',
				component: 'List',
				children: [{
					...
					name: 'batchNumber',
					component: '::div',
					className: 'm-inv-details-batchNumber',
					children: '{{$getCode(data.nowData.code)}}'
				}, {
					name: 'people',
					component: 'List.Item',
					extra: '{{data.nowData.employeeName ? data.nowData.employeeName : data.nowData.operatorName}}',
					children: '报销人 '
				}, {
					name: 'allMoney',
					component: 'List.Item',
					extra: '{{data.nowData.amount}}',
					children: '总金额'
				}, {
					name: 'comment',
					component: 'List.Item',
					extra: '{{data.nowData.memo}}',
					children: '备注'
				}, {
					name: 'all',
					component: 'List.Item',
					extra: '{{data.nowData.enclosureNum}}',
					children: '总张数'
				}, {
					name: 'rejectNumber',
					component: 'List.Item',
					extra: '{{data.nowData.rejectNum}}',
					_visible: '{{ data.isReject }}',
					children: '驳回张数'
				}, {
					name: 'rejectReason',
					component: '::div',
					className: 'm-inv-details-rejectReason',
					_visible: '{{ data.isReject }}',
					children: [{
						name: 'rejectReason',
						component: '::div',
						className: 'm-inv-details-rejectReasonS',
						children: '驳回原因'
					}, {
						name: 'rejectReason',
						component: '::div',
						className: 'm-inv-details-rejectReasonR',
						children: '{{data.nowData.reject}}'
					}]
				}, {
					name: 'invPic',
					component: '::div',
					className: 'm-inv-details-invPic',
					_power: 'for in data.nowData.fileList',
					children: [{
						name: 'pic',
						component: '::img',
						className: 'm-inv-details-pic',
						src: '{{$getPic(data.nowData.fileList[_rowIndex].newName)}}',
						onClick: '{{$handleImageClick(data.nowData.fileList[_rowIndex].newName)}}'
					}, {
						name: 'txt',
						component: '::div',
						className: 'm-inv-details-txt',
						children: [{
							name: 'result',
							component: '::p',
							className: '{{ data.nowData.fileList[_rowIndex].status == "9" ? "m-inv-details-result" : (data.nowData.fileList[_rowIndex].status == "3" ? "m-inv-details-result2" :  (data.nowData.fileList[_rowIndex].status == "6" ? "m-inv-details-result3" :"m-inv-details-result4")) }} ',
							children: '{{$getState(data.nowData.fileList[_rowIndex].status)}}'
						}, {
							name: 'reason',
							component: '::p',
							_visible: '{{data.nowData.fileList[_rowIndex].status == "9" ? true : false}}',
							className: 'm-inv-details-reason',
							children: '{{data.nowData.reject}}'
						}]
					}]
				}]
...
var _mkMetaEngine = __webpack_require__(38);
...
var _mkComponent = __webpack_require__(115);

var _mkMetaEngine = __webpack_require__(38);

var _immutable = __webpack_require__(56);

var _mkUtils = __webpack_require__(19);
...
var action = function action(option) {
    ...
    this.onInit = function (_ref) {
        ...
        // debugger
        var nowData = _this.component.props.data;
        _this.metaAction.sf('data.nowData', (0, _immutable.fromJS)(nowData));
        console.log(nowData);

        if (nowData.status == '1') {
            _this.metaAction.sfs({
                'data.isReject': false,
                'data.mark': 'm-inv-details-mark1'
            });
        } else if (nowData.status == '6') {
            _this.metaAction.sfs({
                'data.isReject': false,
                'data.mark': 'm-inv-details-mark2'
            });
        } else if (nowData.status == '9') {
            _this.metaAction.sfs({
                'data.isReject': true,
                'data.mark': 'm-inv-details-mark3'
            });
        } else if (nowData.status == '4') {
            _this.metaAction.sfs({
                'data.isReject': false,
                'data.mark': 'm-inv-details-mark4'
            });
        } else {
            _this.metaAction.sfs({
                'data.isReject': false,
    ...
    this.getPic = function (data) {
        return _config2.default.current.apiPrefix + '/v1/img/' + data;
    };
    ...
    this.handleImageClick = function (data) {
        return function () {
            var url = _config2.default.current.apiPrefix + '/v1/img/' + data;

            window.PhotoViewer && window.PhotoViewer.show(url, data);
        };
    };
...
exports.default = {
    name: "m-inv-details",
    version: "1.0.0",
    description: "m-inv-details",
    meta: data.getMeta(),
    components: [],
    config: config,
    load: function load(cb) {
        cb(__webpack_require__(50), __webpack_require__(55), __webpack_require__(57));
    }
};
module.exports = exports['default'];
